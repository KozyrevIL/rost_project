...
<body>
    ...
    <noscript>
        <div><img src="https://mc.yandex.ru/watch/59690617" style="position:absolute; left:-9999px;" alt="" /></div>
    </noscript>
    <!-- /Yandex.Metrika counter -->
                ...
                <nav class="navbar navbar-expand-lg navbar-light">
                    ...
                    <div class="collapse navbar-collapse" id="navbarSupportedContent">
                        <ul class="navbar-nav mr-auto ml-0 ml-sm-0 ml-md-3 ml-lg-3 ml-xl-3 ">
                            ...
                            <li class="nav-item">
                                <a class="nav-link" href="{{asset('/')}}">ГЛАВНАЯ</a>
                            </li>

                            <li class="nav-item">
                                <a class="nav-link" href="{{asset('/pageBlock/1') }}">СТАТЬИ</a>
                            </li>
                            <li class="nav-item">
                                <a class="nav-link" href="{{asset('/textBlock/26')}}">НАШИ УСЛУГИ</a>
                            </li>
                            <li class="list-inline-item">
                                <a class="nav-link" href="{{asset('/pageText/9')}}">С НАМИ РАБОТАЮТ</a>
                            </li>
                            <li class="nav-item">
                                <a class="nav-link" href="{{asset('/FormCallBack')}}">КОНСУЛЬТАЦИИ</a>
                            </li>
                            <li class="nav-item">
                                <a class="nav-link" href="{{asset('/textBlock/383')}}">УСЛУГИ НАСЕЛЕНИЮ</a>
                            </li>
                            <li class="nav-item">
                                <a class="nav-link" href="{{asset('/textBlock/9')}}">О КОМПАНИИ</a>
                            </li>
                            <li class="nav-item">
                                <a class="nav-link" href="{{asset('/gallery/8')}}">ФОТОГАЛЕРЕЯ</a>
                            </li>
                            <li class="nav-item">
                                <a class="nav-link" href="{{asset('/textBlock/22')}}">КОНТАКТЫ</a>
                            </li>
                            <li class="nav-item">
                ...
                <div class="row">
                    ...
                    <div class="col-8">
                        ...
                        <ul class="list-inline m-auto">
                            ...
                            <li class="list-inline-item">
                                <a class="nav-link" href="{{asset('/pageText/9')}}">С НАМИ УЖЕ РАБОТАЮТ</a>
                            </li>
                            <li class="list-inline-item">
                                <a class="nav-link" href="{{asset('/textBlock/9')}}">О КОМПАНИИ</a>
                            </li>
                            ...
                            <li class="list-inline-item">
                                <a class="nav-link" href="{{asset('/FormCallBack')}}">ОБРАТНАЯ СВЯЗЬ</a>
                            </li>
                            <li class="list-inline-item">
                                <a class="nav-link" target="_blank" href="https://shop.rostot.ru/">МАГАЗИН</a>
                            </li>
